...
export default function CourierSettings() {
  ...
  useEffect(() => {
    if (tenant?.courierSettings) {
      setSettings((prev) => ({
        ...prev,
        ...tenant.courierSettings,
        packaging: {
          ...prev.packaging,
          ...tenant.courierSettings.packaging
        },
        collectionAddress: {
          ...prev.collectionAddress,
          ...tenant.courierSettings.collectionAddress
        }
      }));
    }
  }, [tenant]);
  ...
  const handleSave = async () => {
    if (!settings.provider) {
      toast.error('Select a courier provider first');
      return;
    }
    setSaving(true);
    try {
